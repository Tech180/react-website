import { Moon, Sun, Power, Zap, Terminal, Monitor } from 'lucide-react';
import styles from './theme-toggle-v2.module.scss';
import { ThemeToggleViewProps } from '@/features/theme/types/theme-toggle.interface';
...
export function ThemeToggleView({
   ...
   */
  const renderIcon = () => {
    if (appearance === "system") return <Monitor size={20} color={isDark ? "rgba(255,255,255,0.2)" : "white"} />;
